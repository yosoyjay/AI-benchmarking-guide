...
"""
    ...
    def test_extracts_from_write_output(self):
        text = """\
...
"""
    ...
    def test_returns_error_for_no_bw_line(self):
        assert fio.parse_fio_output("some random output\nwithout bw") == "error"

    def test_returns_error_for_short_bw_line(self):
...
class TestModuleConstants:
    def test_fio_tests_is_list(self):
